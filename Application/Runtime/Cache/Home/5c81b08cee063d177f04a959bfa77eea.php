...
<div class="user_c w980 clearfix">
    ...
    <link rel="stylesheet" href="<?php echo ($config['view_public']); ?>css/user/user_yhq.css">
<script type="text/javascript">$("title").html('优惠券');</script>

    <div class="R">
        <div class="sortMode"><a class="current" href="#">未使用</a><a href="#">已使用</a><a href="#">已过期</a></div>
        <ul class="data_list">
            <li class="clearfix">
