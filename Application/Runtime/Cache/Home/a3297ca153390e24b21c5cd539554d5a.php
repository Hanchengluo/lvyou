...
<div class="user_c w980 clearfix">
    ...
    <link rel="stylesheet" href="<?php echo ($config['view_public']); ?>css/user/view_jbbm.css">
<script type="text/javascript">$("title").html('查看报名');</script>
        ...
        <ul class="data_list">
            <li class="clearfix">
                ...
                <div class="bmUser">
                    <p>报名用户</p>
                    <ul class="userList">
                        <li><span>姓名</span><span>联系方式</span></li>
                        <li><span>姓名</span><span>联系方式</span></li>
                        <li><span>姓名</span><span>联系方式</span></li>
                        <li><span>姓名</span><span>联系方式</span></li>
                        <li><span>姓名</span><span>联系方式</span></li>
