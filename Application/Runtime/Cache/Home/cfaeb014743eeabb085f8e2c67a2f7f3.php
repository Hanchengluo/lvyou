        ...
        <div class="orderC w1080 clearfix">
            ...
            <div class="R">
                ...
                <div class="B1">
                    ...
                    <ul class="B1InputList clearfix">
                        <li><span>中文姓</span><input type="text"></li>
                        <li><span>中文名</span><input type="text"></li>
                        <li><span>拼音姓</span><input type="text"></li>
                        <li><span>拼音名</span><input type="text"></li>
                        <li style="line-height: 30px;"><span>性别</span>
                            &nbsp;男&nbsp;<input type="radio" checked="checked" name="gender" value="male" />
                            &nbsp;女&nbsp;<input type="radio" name="gender" value="female" />
                        </li>
                        <li><span>国籍</span><input type="text"></li>
                        <li><span>出生日期</span><input type="text"></li>
                        <li><span>出生地</span><input type="text"></li>
                    </ul>
                </div>
                <!--2/-->
                <!--3-->
                ...
                <div class="B2">
                    <ul class="B2InputList">
                        ...
                        <li><span>证件号</span><input type="text"></li>
                        <li><span>有效期</span><input type="text"></li>
                        <li><span>签发地</span><input type="text"></li>
                    </ul>
                </div>
                <!--3/-->
                <!--4-->
                ...
                <div style="height: 48px;line-height: 48px;background-color: #bbb;width: 670px;padding-left: 10px;"><span class="mnum">￥1999</span>
                    <a href="online_pay.html"><div style="float: right;font-size: 16px;line-height: 48px;height: 48px;background-color: #ff7466;padding: 0px 10px;color: #fff;cursor: pointer;">同意以下条款，提交订单</div></a></div>
                <!--7/-->
                <!--8-->
                <h3>预定须知</h3>
                <div>
