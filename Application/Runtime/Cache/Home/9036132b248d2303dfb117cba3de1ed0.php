...
<div class="user_c w980 clearfix">
    ...
    <link rel="stylesheet" href="<?php echo ($config['view_public']); ?>css/user/user_jb.css">
<script type="text/javascript">$("title").html('我的结伴');</script>

    <div class="R">
        <div class="sortMode"><a href="#">我的结伴</a></div>
        <ul class="data_list">
            <?php $__FOR_START_568__=0;$__FOR_END_568__=3;for($i=$__FOR_START_568__;$i < $__FOR_END_568__;$i+=1){ ?><li class="clearfix">
                    ...
                    <div class="meta"><a href="?c=user&a=view_jbbm">查看报名</a><span>报名人数：11</span><span>评论(111)</span></div>
                </li><?php } ?>
        </ul>
    </div>
