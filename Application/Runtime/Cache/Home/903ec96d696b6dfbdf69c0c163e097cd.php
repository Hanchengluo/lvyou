...
<link rel="stylesheet" href="<?php echo ($config['view_public']); ?>css/dist_hotel.css">
<script type="text/javascript">$("title").html('特惠酒店');</script>
</head>
<body>
 <style>
