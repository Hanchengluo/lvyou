...
<link rel="stylesheet" href="<?php echo ($config['view_public']); ?>css/index/visa_details.css">
<script type="text/javascript">$("title").html('签证详情');</script>
</head>
<body>
 <style>
...
<div class="goodsDet">
        ...
        <div class="goodsBuyB">
            ...
            <div class="selectOrBuy clearfix">
                ...
                <div class="R">
                    ...
                    <div class="btn-def" style="margin-top: 20px;float: right;margin-right: 30px;"><a href="visa_write_order.html">立即预定</a></div>
                </div>
            </div>
            <!--5/-->
        </div>
    ...
    <div class="comment w980" style="margin-top: 40px;background-color: #fff;padding: 20px 0 40px 0;">
        <h2 style="padding-left: 20px;text-align: center;font-size: 24px;">咨询</h2>
        ...
        <div style="width: 680px;padding-left:20px; ">
        <div id="comment">
            <a href="#"><img class="tx" src="<?php echo ($config['view_public']); ?>img/tx.jpeg" width="60px"></a>
            <div class="clearfix">
                <div>
