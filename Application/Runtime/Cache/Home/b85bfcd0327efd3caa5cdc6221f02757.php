...
<div class="user_c w980 clearfix">
    ...
    <link rel="stylesheet" href="<?php echo ($config['view_public']); ?>css/user/user_tie.css">
<script type="text/javascript">$("title").html('我的帖子');</script>


    <div class="R">
        <div class="sortMode"><a href="#">我的帖子</a></div>
        <ul class="data_list">
            <li class="clearfix">
                <a class="pic" href="#"><img src="<?php echo ($config['view_public']); ?>img/tx.jpeg" width="200" height="140"></a>
                <div class="info">
                    <h3><a href="#">东京迪士尼度假区</a></h3>
                    <div class="desc">
                        算是马丘比丘里面的一个代表性建筑了，这个建在一个小型洞穴顶部的神庙是古印加人对天文和建筑学造诣的最佳代表。呈半圆形，由...
                    </div>
                    <div class="meta clearfix"><span>55人赞</span></div>
                </div>
            </li>
            <li class="clearfix">
                <a class="pic" href="#"><img src="<?php echo ($config['view_public']); ?>img/tx.jpeg" width="200" height="140"></a>
                <div class="info">
                    <h3><a href="#">东京迪士尼度假区东京迪士尼度假区东京迪士尼度假区东京迪士尼度假区东京迪士尼度假区东京迪士尼度假区</a></h3>
                    <div class="desc">
                        算是马丘比丘里面的一个代表性建筑了，这个建在一个小型洞穴顶部的神庙是古印加人对天文和建筑学造诣的最佳代表。呈半圆形，由...
                    </div>
                    <div class="meta clearfix"><span>55人赞</span></div>
            ...
            <li class="clearfix">
                ...
                <div class="info">
                    <h3><a href="#">东京迪士尼度假区</a></h3>
                    <div class="desc">
                        算是马丘比丘里面的一个代表性建筑了，这个建在一个小型洞穴顶部的神庙是古印加人对天文和建筑学造诣的最佳代表。呈半圆形，由面的一个代表性建筑了，这个建在一个小型洞穴顶部的神庙是古印加人对天文和建筑学造诣的最佳代表。呈半圆形，由面的一个代表性建筑了，这个建在一个小型洞穴顶部的神庙是古印加人对天文和建筑学造诣的最佳代表。呈半圆形，由面的一个代表性建筑了，这个建在一个小型洞穴顶部的神庙是古印加人对天文和建筑学造诣的最佳代表。呈半圆形，由...
                    </div>
                    <div class="meta clearfix"><span>55人赞</span></div>
                </div>
            </li>
...
<!--主体区 end-->
 <style>
        ...
        .link>li>span{font-size: 16px;line-height: 38px;height:38px;font-weight: bold;}
