...
<link rel="stylesheet" href="<?php echo ($config['view_public']); ?>css/district/dist_gl.css">
<script type="text/javascript">$("title").html('旅游攻略');</script>
</head>
<body>
 <style>
...
<div class="C w980 clearfix">
    <!--1-->
    <div class="L">
        <div class="sortMode"><a class="current" href="#">推荐</a><a href="#">人气</a><a href="#">最新</a><a href="#">精华</a></div>
        <ul class="travelList">
            <li>
                <a class="pic" href="#"><img src="<?php echo ($config['view_public']); ?>img/tx.jpeg" width="227" height="150"></a>
                <div class="info">
                    <h3><a href="#">【完结】【我的理想三旬】17年春节❤马丘比丘❤乌尤尼</a></h3>
                    <div class="meta">
                        <span>作者：<a href="#">xiaom</a></span>
                        <span class="time">2017-05-06</span>
                        <span>游览(999)</span>
                    </div>
                    <div class="desc">
                        El Tambo Machupicchu旅馆距离主广场有3分钟的步行路程，提供带免费无线网络连接的住宿。 每间客房均设有一间带吹风机的私人浴室以及一台有线电视。客房亦享有城市和山...
                    </div>
                </div>
            </li>
            <li>
